        ...
        <div>
          ...
          <div className="m-3">
            <table className="table ">
              ...
              <tbody>
                <tr>
                  <td className="px-6 py-4  border Border-white">{candidates.FirstName}</td>
                  <td className="px-6 py-4  border Border-white">{candidates.LastName}</td>
                  <td className="px-6 py-4  border Border-white">{candidates.Email}</td>
                  <td className="px-6 py-4  border Border-white">{candidates.Phone}</td>
                  <td className="px-6 py-4  border Border-white">
                    {candidates.BookDate ? format(parseISO(candidates.BookDate), 'yyyy-MM-dd') : ''}
                  </td>
                  <td className="px-6 py-4   border Border-white ">{candidates.title}</td>
                  <td className="px-6 py-4   border Border-white ">{candidates.PaymentStatus}</td>
                  <td className="px-6 py-4 whitespace-nowrap border Border-white">
                    <div className="d-flex align-items-center justify-content-center space-x-4 m-2">
                      <div className="bg-primary rounded">
                        <button
                          className="bg-primary text-white font-bold m-1 py-1 px-2 border border-primary"
                          type="button"
                          onClick={() => {
                      ...
                      <div className="bg-danger rounded">
                        <button
                          className="bg-danger text-white font-bold m-1 py-1 px-2 border border-danger"
                          type="button"
                          onClick={() => {
