...
//   const[CountDay,SetContDay]=useState([5]) 
...
//   };
//   // useEffect(() => {
//   //   Axios.get('http://localhost:8000/TEFEtudes/count-registrations-by-date')
//   //     .then((response) => {
...
//           const bookDate = new Date(count.BookDate);
//           const registrationCount = count.registration_count;
//           const maxRegistrationsPerDay = 4;

//           if (registrationCount >= maxRegistrationsPerDay) {
//             disabledDates.push(bookDate);
//           }
//         });

//         SetContDay(disabledDates);
//       })
//       .catch((error) => {
