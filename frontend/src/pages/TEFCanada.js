...
const TEFCanada = () => {
  ...
  useEffect(() => {
    ...
    Axios.get('http://localhost:8000/TEFCanada/TEFCanada') 
      .then((response) => {
      ...
      <div className="card m-3">
        <div className="row">
          <div className="col d-flex align-items-center">
            ...
            <h5 className="h5 pt-2">&gt; TEF Canada - Procédures d'immigration / Demande de citoyenneté</h5>
          </div>
        </div>
        <div className="line"></div>
        <div className="row px-3 pb-3">
          <h3 className="card-header">TEF Canada – Procédures d’immigration / Demande de citoyenneté</h3>
